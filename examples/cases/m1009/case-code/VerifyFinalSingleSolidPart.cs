...
public static class VerifyFinalSingleSolidPart
{
    ...
    private static readonly string FinalPart = Path.Combine(Workspace, "最终交付_SLDPRT", "M1009_curved_face_block_complete_single_solid.SLDPRT");
